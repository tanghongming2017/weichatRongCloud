                    ...
                    ThreadPoolFactory.getNormalPool().execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (TextUtils.isEmpty(result)) {
                                UIUtils.showToastSafely(UIUtils.getString(R.string.scan_fail));
                            } else {
                                handleResult(result);
                            }
                        }
    ...
    private void handleResult(String result) {
        ...
        if (result.startsWith(AppConst.QrCodeCommon.ADD)) {
            ...
            if (DBManager.getInstance().isMyFriend(account)) {
                UIUtils.showToastSafely(UIUtils.getString(R.string.this_account_was_your_friend));
                return;
            }
        ...
        //进群
            ...
            if (DBManager.getInstance().isInThisGroup(groupId)) {
                UIUtils.showToastSafely(UIUtils.getString(R.string.you_already_in_this_group));
                return;
            } else {
